/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 976fdd899922c186e79e037ce12882b3)
// Runtime types generated with workerd@1.20260826.1 2026-06-11 nodejs_compat
interface __BaseEnv_Env {
	TELEMETRY_DB: D1Database;
	INVESTIGATION_CHAOS: "disabled";
	ANTHROPIC_API_KEY: string;
	SLACK_WEBHOOK_URL: string;
	InvestigationAgent: DurableObjectNamespace<import("./src/server").InvestigationAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "InvestigationAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INVESTIGATION_CHAOS" | "ANTHROPIC_API_KEY" | "SLACK_WEBHOOK_URL">> {}
}
